...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.filebrowserImageUrl = '/Assets/admin/plugins/ckfinder/ckfinder.html?Type=Images';
    config.filebrowserFlashUrl = '/Assets/admin/plugins/ckfinder/ckfinder.html?Type=Flash';
